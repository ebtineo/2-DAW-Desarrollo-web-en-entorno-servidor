/*
 * Servlet muy educado que te saluda por tu nombre
 */
package servlets;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (nombre == null) {
                ...
                out.println("<label>Introduce tu nombre</label>");
                ...
                out.println("<form action='HolaMundo'>");
                out.println("<input type='submit' value='Ver la hora'>");
                out.println("</form>");
            }
            out.println("</body>");
            out.println("</html>");
