...
public class ejercicio5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ejercicio5 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public static String muestraParametros(HttpServletRequest r){
        List nombres = Collections.list(r.getParameterNames());
        String valor;
        String resultado = "<table border='1'>";
        
        for (Object nombre : nombres) {
            valor = r.getParameter((String)nombre);
            resultado += "<tr>";
