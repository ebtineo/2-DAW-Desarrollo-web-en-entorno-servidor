 ...
 * @author jose
 */
@WebServlet(name = "E04EcuSegundoGrado_VersionAmieva", urlPatterns = {"/E04EcuSegundoGrado_VersionAmieva"})
public class E04EcuSegundoGrado_VersionAmieva extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<link rel='stylesheet' href='css/estilo_Amieva.css'>");
            out.println("</head>");
            out.println("<body>");
