    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (frase == null) {
                ...
                out.println("<label>");
                out.println("Introduzca su frase:");
                out.println("</label>");
                out.println("<input type='text' value='Frase' name='frase'>");
                out.println("<input type='submit' value='Enviar'>");
            } else {
                out.println("<p> Tu frase en mayúsculas:</p>");
                out.println("<h1>" + frase.toUpperCase() + "</h1>");
